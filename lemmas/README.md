...
| file | lemma | contents |
|---|---|---|
| [`affine_seed.g`](affine_seed.g) | Lemma 3.3 | the monomial group `L0 = D:P` of order 1152 in `GL(9,3)`: irreducibility, the two regular orbits, the monochromatic triple sums, and the two-sum pattern of the all-ones vector |
