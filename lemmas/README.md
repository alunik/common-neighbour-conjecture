...
| file | lemma | contents |
|---|---|---|
| [`affine_input.g`](affine_input.g) | Lemma 3.1 | the monomial group `L0 = D:P` of order 1152 in `GL(9,3)`: irreducibility, the two regular orbits, their self-sum data, and the two-sum pattern of the all-ones vector |
